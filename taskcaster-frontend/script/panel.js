...
async function createAssignedTasks() {
  const html = `
        <div class="panel-dropdown assigned-tasks-button">
          <div class="menu-item ">
...
async function createProjectsButton() {
  const html = `
    <div class="panel-dropdown projects-list-button">
          <div class="menu-item ">
...
async function syncPanel() {
  const projectsButton = await document.querySelector(".projects-list-button");
  const assignedTasksButton = await document.querySelector(
    ".assigned-tasks-button"
  );

  const projects = await apiService.getProjects();
  const projectsList = projectsButton.querySelector(".menu-item-content-list");
  ...
  const assignedTasks = await apiService.getAssignedTasks();
  const assignedTasksList = assignedTasksButton.querySelector(
